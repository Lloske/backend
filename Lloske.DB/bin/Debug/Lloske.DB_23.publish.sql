...
CREATE TABLE [dbo].[MM_job_position_workplaces] (
    [FK_id_job_position]               INT IDENTITY (1, 1) NOT NULL,
    [FK_id_workplace]                  INT NOT NULL,
    [FK_id_user_personnal_information] INT NOT NULL,
...
CREATE TABLE [dbo].[MM_organization_user] (
    [FK_PK_id_organization] INT IDENTITY (1, 1) NOT NULL,
...
CREATE TABLE [dbo].[MM_workplaces_user] (
    ...
    [FK_id_workplace]                  INT      IDENTITY (1, 1) NOT NULL,
    [FK_id_user_personnal_information] INT      NOT NULL,
...
INSERT INTO [user_contract_information] ([Id], [Contract_type], [Employment_type], [Job_title], [Organization_entry_date], [Contract_start], [Probation_end_date], [Contract_end], [Status], [Professional_category], [Last_medical_checkup_date])
	VALUES ( 1, 1, 1, 'Gestionnaire Multifonction', '2017-01-01', '2017-01-01 06:00:00', '2017-04-01', '2017-09-01', 4, 4, '2017-01-01');
